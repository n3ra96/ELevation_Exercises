let recipe = {
    ...
    ingredients: [
      { name: 'water' },    
      { name: 'potatoes', count: 2 },
      { name: 'butter', count: 2, unit: 'tablespoons' },
      { name: 'salt', count: 0.5, unit: 'teaspoon' },
      { name: 'pepper', count: 0.25, unit: 'teaspoons' },
      { name: 'garlic powder', count: 2, unit: 'teaspoons' }
    ],
    directions: [
...
recipe["healthy"]= true
recipe["calories"]= 250
recipe.directions.splice(0, 0, "Cut potatoes into half inch thick slices")
